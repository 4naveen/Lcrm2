...
import com.project.lorvent.lcrm.fragments.admin.edit.LoggedCallEditFragment;
...
public class DetailsLoggedCallActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (AppSession.loggedcall_write==0&&AppSession.loggedcall_delete==0)
        {
        ...
        fabOptions.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch (v.getId()) {
                    case R.id.edit:
                    {
                        fragment=new LoggedCallEditFragment();
                        Bundle bundle=new Bundle();
                        bundle.putString("callId",call_id);
    ...
    private class DeleteCall extends AsyncTask<String,Void,String>
    {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                String delete_url;
                if (text_url != null) {
                    delete_url = text_url + "/user/delete_call?token=";
                } else {
                    delete_url = Appconfig.DELETE_CALL_URL;
                }
