...
import static com.project.lorvent.lcrm.utils.AppSession.qTemplateList;
...
public class AddQuotationActivity extends AppCompatActivity {
    ...
    public static ArrayList<String>quotation_templateNameList;
    ...
    TextInputLayout input_customer,input_qtemplate,input_date,input_exp_date,input_pay_term,input_salesteam,input_salesperson,
            input_status,input_total,input_tax,input_gtotal,input_discount,input_final_price;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Connection.getStaffList(Appconfig.TOKEN,AddQuotationActivity.this);
        Connection.getContactList(Appconfig.TOKEN,AddQuotationActivity.this);
        Connection.getSalesTeamList(Appconfig.TOKEN,AddQuotationActivity.this);
        Connection.getDateSettings(Appconfig.TOKEN,AddQuotationActivity.this);
        Connection.getProductList(Appconfig.TOKEN,AddQuotationActivity.this);
        getQtemplateList(Appconfig.TOKEN);

        ActionBar actionBar = getSupportActionBar();
        linearLayout=(LinearLayout)findViewById(R.id.layout);
        if (actionBar != null) {
            actionBar.setTitle("Add Quotation");
        }
        if (actionBar != null) {
        ...
        /*input_total=(TextInputLayout)findViewById(R.id.input_layout_total);
        input_tax=(TextInputLayout)findViewById(R.id.input_layout_tax);
        input_gtotal=(TextInputLayout)findViewById(R.id.input_layout_gtotal);
        input_discount=(TextInputLayout)findViewById(R.id.input_layout_discount);
        input_final_price=(TextInputLayout)findViewById(R.id.input_layout_final_price);*/
       ...
       // productNameList = new ArrayList<String>();
        ...
        qtemplateArrayList=new ArrayList<>();
        quotation_templateNameList=new ArrayList<>();
        ...
        customer.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                ArrayAdapter<String> customerArrayAdapter = new ArrayAdapter<>(AddQuotationActivity.this, android.R.layout.simple_spinner_item, AppSession.customerNameList);
        ...
        quotation_template.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            @Override
            public void onFocusChange(View v, boolean hasFocus) {
                ArrayAdapter<String> quotation_templateArrayAdapter = new ArrayAdapter<>(AddQuotationActivity.this, android.R.layout.simple_spinner_item, quotation_templateNameList);
        ...
        add_products.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MaterialDialog dialog1=new MaterialDialog.Builder(AddQuotationActivity.this)
                        .title("Add Products")
                        ...
                        .onPositive(new MaterialDialog.SingleButtonCallback() {
                            ...
                            public void onClick(@NonNull MaterialDialog dialog, @NonNull DialogAction which) {
                                ...
                                TableRow row = new TableRow(AddQuotationActivity.this);
                                ...
                                TextView product = new TextView(AddQuotationActivity.this);
                                ...
                                TextView quantity = new TextView(AddQuotationActivity.this);
                                ...
                                TextView unit_price = new TextView(AddQuotationActivity.this);
                               ...
                               /* TextView description = new TextView(AddQuotationActivity.this);
                                description.setText(selected_description);*/
                                description_array.add(selected_description);
                                product.setVisibility(View.VISIBLE);

                                TextView sub_total = new TextView(AddQuotationActivity.this);
...
//                         String product_name_text=productNameList.get(position);
                    ...
                    /*        description.setText(AppSession.description);
                            unit_price.setText(AppSession.unit_price);*/
                ...
                ArrayAdapter<String> product_nameArrayAdapter = new ArrayAdapter<>(AddQuotationActivity.this, android.R.layout.simple_dropdown_item_1line,AppSession.productNameList);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int qtemplateId= qTemplateList.get(quotation_templateNameList.indexOf(quotation_template.getText().toString())).getId();

                new AddQuotation().execute(Appconfig.TOKEN,String.valueOf(customerId), String.valueOf(qtemplateId), start_date.getText().toString(),
                        ...
                        AppSession.quotation_start_number);
    ...
    protected Dialog onCreateDialog(int id) {
        if (id == START_DATE_PICKER_ID) {
            return new DatePickerDialog(AddQuotationActivity.this, start_date_listener, start_year, start_month, start_day);
        }
        if (id == EXP_DATE_PICKER_ID) {
            return new DatePickerDialog(AddQuotationActivity.this, exp_date_listener, exp_year, exp_month, exp_day);
        }
        return null;
    }
    ...
    private class AddQuotation extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = new ProgressDialog(AddQuotationActivity.this);
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                String post_quotation_url;
                if (text_url != null) {
                    post_quotation_url = text_url + "/user/post_quotation?token=";
                } else {
                    post_quotation_url = Appconfig.POST_QUOTATION_URL;
                }
                url = new URL(post_quotation_url+ tok);
                ...
                public void onResponse(String response) {
                    try {
                        ...
                        for (int i=0;i<jsonArray.length();i++)
                        {
                            ...
                            quotation_templateNameList.add(object.getString("quotation_template"));
    ...
    {   String response;
        ...
        protected void onPostExecute(String response) {
            try {
                ...
                QuotationAdapter mAdapter=new QuotationAdapter(getApplicationContext(), AppSession.quotationArrayList);
