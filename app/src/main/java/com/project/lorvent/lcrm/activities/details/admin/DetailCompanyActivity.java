...
import com.project.lorvent.lcrm.fragments.admin.edit.CompanyEditFragment;
...
public class DetailCompanyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (AppSession.contacts_write==0&&AppSession.contacts_delete==0)
        {
        ...
        fabOptions.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch (v.getId()) {
                    case R.id.edit:
                    {
                        fragment=new CompanyEditFragment();
                        Bundle bundle=new Bundle();
                        bundle.putString("company_id",company_id);
    ...
    private class DeleteCompany extends AsyncTask<String,Void,String>
    {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                String delete_url;
                if (text_url != null) {
                    delete_url = text_url + "/user/delete_company?token=";
                } else {
                    delete_url = Appconfig.COMPANY_DELETE_URL;
                }
