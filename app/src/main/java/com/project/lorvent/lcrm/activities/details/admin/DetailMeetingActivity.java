...
import com.project.lorvent.lcrm.fragments.admin.edit.MeetingEditFragment;
...
public class DetailMeetingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (AppSession.meeting_write==0&&AppSession.meeting_delete==0)
        {
        ...
        fabOptions.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch (v.getId()) {
                    case R.id.edit: {
                        fragment=new MeetingEditFragment();
                        Bundle bundle=new Bundle();
                        bundle.putString("meetingId",meeting_id);
    ...
    private class DeleteMeeting extends AsyncTask<String,Void,String>
    {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                String delete_url;
                if (text_url != null) {
                    delete_url = text_url + "/user/delete_meeting?token=";
                } else {
                    delete_url = Appconfig.MEETING_DELETE_URL;
                }
