...
import com.project.naveen.lcrm.leads.CallFragment;
import com.project.naveen.lcrm.leads.DetailsFragment;
import com.project.naveen.lcrm.leads.EditLeadFragment;
...
LeadAdapter leadAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_details_lead);
    ...
    private class DeleteLead extends AsyncTask<String,Void,String>
    {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                url = new URL(Appconfig.DELETE_LEAD_URL+tok);
