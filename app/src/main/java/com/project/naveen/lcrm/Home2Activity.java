...
public class Home2Activity extends AppCompatActivity  implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Appconfig.homeActivity=Home2Activity.this;
...
//            menu.add("SalesTeam");
        ...
        {
            navigationView.getMenu().findItem(R.id.contacts).setVisible(true);
        }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        else if (navigationView.getMenu().findItem(R.id.contacts).isVisible()&&item.getItemId()==R.id.contacts)
        {
