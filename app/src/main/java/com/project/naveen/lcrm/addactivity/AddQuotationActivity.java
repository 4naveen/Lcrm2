      ...
      /*  new GetAllProductsTask().execute(token);*/
        ...
        add_products.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final Dialog dialog = new Dialog(AddQuotationActivity.this);
                ...
                ArrayAdapter<String> product_nameArrayAdapter = new ArrayAdapter<>(AddQuotationActivity.this, android.R.layout.simple_dropdown_item_1line, productNameList);
...
/*        start_date.setOnClickListener(new View.OnClickListener() {
    ...
    /*            else if (total.getText().toString().isEmpty()){
                    input_total.setError("Please select stages");
                    return;
                }
                else if (tax.getText().toString().isEmpty()){
                    input_tax.setError("Please select stages");
                    return;
                }
                else if (gtotal.getText().toString().isEmpty()){
                    input_gtotal.setError("Please select stages");
                    return;
                }
                else if (discount.getText().toString().isEmpty()){
                    input_discount.setError("Please select stages");
                    return;
                }
                else if (final_price.getText().toString().isEmpty()){
                    input_final_price.setError("Please select stages");
                    return;
                }*/
                else {
                    //do nothing
                ...
                new AddQuotation().execute(Appconfig.TOKEN, "105", String.valueOf(qtemplateId), start_date.getText().toString(),
    ...
    class AddQuotation extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                url = new URL(Appconfig.POST_QUOTATION_URL + tok);
